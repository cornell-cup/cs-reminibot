...
Blockly.Blocks.lists_getIndex = {
	init: function () {
		...
		this.setTooltip(function () {
			...
			if ('FROM_START' == e || 'FROM_END' == e)
				d +=
					'  ' +
					('FROM_START' == e ? Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP : Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace(
						'%1',
	...
	updateStatement_: function (a) {
		a != !this.outputConnection &&
			(this.unplug(!0, !0),
			a
				? (this.setOutput(!1), this.setPreviousStatement(!0), this.setNextStatement(!0))
				: (this.setPreviousStatement(!1), this.setNextStatement(!1), this.setOutput(!0)));
	},
...
Blockly.Blocks.lists_setIndex = {
	init: function () {
		...
		this.setTooltip(function () {
			...
			if ('FROM_START' == e || 'FROM_END' == e)
				d += '  ' + Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace('%1', b.workspace.options.oneBasedIndex ? '#1' : '#0');
			return d;
		});
	},
	mutationToDom: function () {
	...
	updateAt_: function (a, b) {
		...
		b
			? (this.appendValueInput('AT' + a).setCheck('Number'),
			  Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput('ORDINAL' + a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX))
...
Blockly.Blocks.lists_split = {
	...
	updateType_: function (a) {
		'SPLIT' == a
			? (this.outputConnection.setCheck('Array'), this.getInput('INPUT').setCheck('String'))
...
Blockly.Blocks.math_change = {
	init: function () {
		this.jsonInit({
			...
			args0: [
				{ type: 'field_variable', name: 'VAR', variable: Blockly.Msg.MATH_CHANGE_TITLE_ITEM },
...
Blockly.Blocks.variables_set = {
	init: function () {
		this.jsonInit({
			...
			args0: [
				{ type: 'field_variable', name: 'VAR', variable: Blockly.Msg.VARIABLES_DEFAULT_NAME },
...
Blockly.Blocks.procedures_defnoreturn = {
	...
	renameVar: function (a, b) {
		for (var c = !1, e = 0; e < this.arguments_.length; e++)
			Blockly.Names.equals(a, this.arguments_[e]) && ((this.arguments_[e] = b), (c = !0));
		if (c && (this.updateParams_(), this.mutator.isVisible()))
			for (var c = this.mutator.workspace_.getAllBlocks(), e = 0, d; (d = c[e]); e++)
				'procedures_mutatorarg' == d.type && Blockly.Names.equals(a, d.getFieldValue('NAME')) && d.setFieldValue(b, 'NAME');
	},
	customContextMenu: function (a) {
		var b = { enabled: !0 },
		...
		for (var d = 0; d < this.arguments_.length; d++)
			(c = goog.dom.createDom('arg')), c.setAttribute('name', this.arguments_[d]), e.appendChild(c);
...
Blockly.Blocks.procedures_callnoreturn = {
	...
	renameProcedure: function (a, b) {
		Blockly.Names.equals(a, this.getProcedureCall()) &&
			...
			this.setTooltip(
				(this.outputConnection ? Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP : Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP).replace('%1', b)
			));
	},
			...
			if (goog.array.equals(this.arguments_, a)) this.quarkIds_ = b;
				...
				for (var d = 0; d < this.arguments_.length; d++) {
					...
					f &&
						...
						e && f && -1 == b.indexOf(this.quarkIds_[d]) && (f.disconnect(), f.getSourceBlock().bumpNeighbours_()));
				}
					...
					for (d = 0; d < this.arguments_.length; d++)
						(e = this.quarkIds_[d]),
							e in this.quarkConnections_ &&
								((f = this.quarkConnections_[e]), Blockly.Mutator.reconnect(f, this, 'ARG' + d) || delete this.quarkConnections_[e]);
	...
	domToMutation: function (a) {
		...
		for (var b = [], c = [], e = 0, d; (d = a.childNodes[e]); e++)
			'arg' == d.nodeName.toLowerCase() && (b.push(d.getAttribute('name')), c.push(d.getAttribute('paramId')));
...
Blockly.Blocks.procedures_ifreturn = {
	...
	domToMutation: function (a) {
		...
		this.hasReturnValue_ ||
			(this.removeInput('VALUE'), this.appendDummyInput('VALUE').appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN));
	},
	onchange: function (a) {
	...
	init: function () {
		...
		this.setTooltip(function () {
			...
			if ('FROM_START' == b || 'FROM_END' == b)
				c +=
					'  ' +
					('FROM_START' == b ? Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP : Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace(
						'%1',
...
Blockly.Blocks.text_getSubstring = {
	...
	updateAt_: function (a, b) {
		...
		2 == a &&
			...
			(this.removeInput('TAIL', !0), this.appendDummyInput('TAIL').appendField(Blockly.Msg.TEXT_GET_SUBSTRING_TAIL));
		var c = new Blockly.FieldDropdown(this['WHERE_OPTIONS_' + a], function (c) {
			var d = 'FROM_START' == c || 'FROM_END' == c;
			if (d != b) {
				var e = this.sourceBlock_;
...
Blockly.Blocks.logic_operation = {
	init: function () {
		...
		this.setTooltip(function () {
			var a = b.getFieldValue('OP');
			return { AND: Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND, OR: Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR }[a];
		});
	}
};
		...
		if ((b || c) && e)
			for (var d = 0; 2 > d; d++) {
				...
				f &&
					...
					(Blockly.Events.setGroup(a.group),
					e === this.prevParentConnection_ ? (this.unplug(), e.getSourceBlock().bumpNeighbours_()) : (f.unplug(), f.bumpNeighbours_()),
					Blockly.Events.setGroup(!1));
			}
