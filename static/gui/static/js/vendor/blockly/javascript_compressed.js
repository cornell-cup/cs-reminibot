...
Blockly.JavaScript.getAdjusted = function (a, b, c, d, e) {
	...
	a =
		0 < c
			? Blockly.JavaScript.valueToCode(a, b, Blockly.JavaScript.ORDER_ADDITION) || f
			: 0 > c
			? Blockly.JavaScript.valueToCode(a, b, Blockly.JavaScript.ORDER_SUBTRACTION) || f
			: d
			? Blockly.JavaScript.valueToCode(a, b, Blockly.JavaScript.ORDER_UNARY_NEGATION) || f
...
Blockly.JavaScript.lists_length = function (a) {
	return [
		(Blockly.JavaScript.valueToCode(a, 'VALUE', Blockly.JavaScript.ORDER_MEMBER) || '[]') + '.length',
...
Blockly.JavaScript.lists_getIndex = function (a) {
	var b = a.getFieldValue('MODE') || 'GET',
		...
		d =
			Blockly.JavaScript.valueToCode(a, 'VALUE', 'RANDOM' == c ? Blockly.JavaScript.ORDER_COMMA : Blockly.JavaScript.ORDER_MEMBER) || '[]';
	switch (c) {
		case 'FIRST':
...
Blockly.JavaScript.math_single = function (a) {
	...
	if ('NEG' == b)
		return (
			(a = Blockly.JavaScript.valueToCode(a, 'NUM', Blockly.JavaScript.ORDER_UNARY_NEGATION) || '0'),
			'-' == a[0] && (a = ' ' + a),
			['-' + a, Blockly.JavaScript.ORDER_UNARY_NEGATION]
		);
	a =
		'SIN' == b || 'COS' == b || 'TAN' == b
			? Blockly.JavaScript.valueToCode(a, 'NUM', Blockly.JavaScript.ORDER_DIVISION) || '0'
			: Blockly.JavaScript.valueToCode(a, 'NUM', Blockly.JavaScript.ORDER_NONE) || '0';
	switch (b) {
		case 'ABS':
			c = 'Math.abs(' + a + ')';
			break;
...
Blockly.JavaScript.colour_blend = function (a) {
	...
	a = Blockly.JavaScript.valueToCode(a, 'RATIO', Blockly.JavaScript.ORDER_COMMA) || 0.5;
	return [
...
Blockly.JavaScript.procedures_defreturn = function (a) {
	...
	Blockly.JavaScript.STATEMENT_PREFIX &&
		(c =
			Blockly.JavaScript.prefixLines(Blockly.JavaScript.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'"), Blockly.JavaScript.INDENT) + c);
...
Blockly.JavaScript.procedures_callreturn = function (a) {
	for (
		var b = Blockly.JavaScript.variableDB_.getName(a.getFieldValue('NAME'), Blockly.Procedures.NAME_TYPE), c = [], d = 0;
...
Blockly.JavaScript.procedures_ifreturn = function (a) {
	...
	a.hasReturnValue_
		? ((a = Blockly.JavaScript.valueToCode(a, 'VALUE', Blockly.JavaScript.ORDER_NONE) || 'null'), (b += '  return ' + a + ';\n'))
		: (b += '  return;\n');
	return b + '}\n';
};
...
Blockly.JavaScript.text_join = function (a) {
	switch (a.itemCount_) {
		...
		case 1:
			return [
				'String(' + (Blockly.JavaScript.valueToCode(a, 'ADD0', Blockly.JavaScript.ORDER_NONE) || "''") + ')',
				Blockly.JavaScript.ORDER_FUNCTION_CALL
			];
		case 2:
...
Blockly.JavaScript.text_length = function (a) {
	return [
		(Blockly.JavaScript.valueToCode(a, 'VALUE', Blockly.JavaScript.ORDER_FUNCTION_CALL) || "''") + '.length',
		Blockly.JavaScript.ORDER_MEMBER
	];
};
...
Blockly.JavaScript.text_charAt = function (a) {
	...
	switch (b) {
		...
		case 'FROM_END':
			return (
				(a = Blockly.JavaScript.getAdjusted(a, 'AT', 1, !0)), [c + '.slice(' + a + ').charAt(0)', Blockly.JavaScript.ORDER_FUNCTION_CALL]
			);
		case 'RANDOM':
			return [
...
Blockly.JavaScript.controls_repeat_ext = function (a) {
	var b = a.getField('TIMES')
			...
			: Blockly.JavaScript.valueToCode(a, 'TIMES', Blockly.JavaScript.ORDER_ASSIGNMENT) || '0',
	...
	b.match(/^\w+$/) ||
		Blockly.isNumber(b) ||
		((e = Blockly.JavaScript.variableDB_.getDistinctName('repeat_end', Blockly.Variables.NAME_TYPE)),
		(a += 'var ' + e + ' = ' + b + ';\n'));
...
Blockly.JavaScript.controls_for = function (a) {
	...
	if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
		...
		(a = ''),
			...
			c.match(/^\w+$/) ||
				Blockly.isNumber(c) ||
				((g = Blockly.JavaScript.variableDB_.getDistinctName(b + '_start', Blockly.Variables.NAME_TYPE)),
				(a += 'var ' + g + ' = ' + c + ';\n')),
			(c = d),
			d.match(/^\w+$/) ||
				Blockly.isNumber(d) ||
				((c = Blockly.JavaScript.variableDB_.getDistinctName(b + '_end', Blockly.Variables.NAME_TYPE)),
				(a += 'var ' + c + ' = ' + d + ';\n')),
...
Blockly.JavaScript.controls_forEach = function (a) {
	...
	var e = c;
	c.match(/^\w+$/) ||
		((e = Blockly.JavaScript.variableDB_.getDistinctName(b + '_list', Blockly.Variables.NAME_TYPE)), (a += 'var ' + e + ' = ' + c + ';\n'));
