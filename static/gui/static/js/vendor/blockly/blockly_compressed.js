...
goog.DEPENDENCIES_ENABLED &&
	...
	(goog.allDepsAreAvailable_ = function (a) {
		if ((a = goog.getPathFromDeps_(a)) && a in goog.dependencies_.requires)
			for (var b in goog.dependencies_.requires[a]) if (!goog.isProvided_(b) && !goog.isDeferredModule_(b)) return !1;
		return !0;
	}),
	...
	(goog.writeScripts_ = function (a) {
		...
		for (a = 0; a < c.length; a++)
			if ((f = c[a])) {
				...
				'goog' == h.module || k
					? goog.importProcessedScript_(goog.basePath + f, 'goog' == h.module, k)
...
goog.loadModule = function (a) {
	...
	try {
		...
		goog.moduleLoaderState_.declareLegacyNamespace
			...
			: goog.SEAL_MODULE_EXPORTS && Object.seal && goog.isObject(c) && Object.seal(c);
...
goog.typeOf = function (a) {
	...
	if ('object' == b)
		if (a) {
			...
			if (
				'[object Function]' == c ||
				('undefined' != typeof a.call && 'undefined' != typeof a.propertyIsEnumerable && !a.propertyIsEnumerable('call'))
			)
				return 'function';
		} else return 'null';
...
goog.asserts.fail = function (a, b) {
	goog.asserts.ENABLE_ASSERTS &&
		goog.asserts.errorHandler_(new goog.asserts.AssertionError('Failure' + (a ? ': ' + a : ''), Array.prototype.slice.call(arguments, 1)));
};
goog.asserts.assertNumber = function (a, b, c) {
	goog.asserts.ENABLE_ASSERTS &&
		!goog.isNumber(a) &&
		goog.asserts.doAssertFailure_('Expected number but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
goog.asserts.assertString = function (a, b, c) {
	goog.asserts.ENABLE_ASSERTS &&
		!goog.isString(a) &&
		goog.asserts.doAssertFailure_('Expected string but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
...
goog.asserts.assertObject = function (a, b, c) {
	goog.asserts.ENABLE_ASSERTS &&
		!goog.isObject(a) &&
		goog.asserts.doAssertFailure_('Expected object but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
goog.asserts.assertArray = function (a, b, c) {
	goog.asserts.ENABLE_ASSERTS &&
		!goog.isArray(a) &&
		goog.asserts.doAssertFailure_('Expected array but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
goog.asserts.assertBoolean = function (a, b, c) {
	goog.asserts.ENABLE_ASSERTS &&
		!goog.isBoolean(a) &&
		goog.asserts.doAssertFailure_('Expected boolean but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
goog.asserts.assertElement = function (a, b, c) {
	!goog.asserts.ENABLE_ASSERTS ||
		(goog.isObject(a) && a.nodeType == goog.dom.NodeType.ELEMENT) ||
		goog.asserts.doAssertFailure_('Expected Element but got %s: %s.', [goog.typeOf(a), a], b, Array.prototype.slice.call(arguments, 2));
	return a;
};
...
goog.labs.userAgent.platform.getVersion = function () {
	...
	goog.labs.userAgent.platform.isWindows()
		...
		: goog.labs.userAgent.platform.isChromeOS() && ((b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/), (b = (a = b.exec(a)) && a[1]));
	return b || '';
};
...
goog.Disposable.prototype.addOnDisposeCallback = function (a, b) {
	this.disposed_
		? goog.isDef(b)
			? a.call(b)
			: a()
		: (this.onDisposeCallbacks_ || (this.onDisposeCallbacks_ = []), this.onDisposeCallbacks_.push(goog.isDef(b) ? goog.bind(a, b) : a));
};
...
goog.events.BrowserEvent.prototype.init = function (a, b) {
	...
	e
		? goog.userAgent.GECKO && (goog.reflect.canAccessProperty(e, 'nodeName') || (e = null))
...
goog.events.ListenerMap.prototype.add = function (a, b, c, d, e) {
	...
	-1 < g
		...
		: ((b = new goog.events.Listener(b, null, this.src, f, !!d, e)), (b.callOnce = c), a.push(b));
	return b;
};
goog.events.ListenerMap.prototype.remove = function (a, b, c, d) {
	...
	return -1 < b
		? (e[b].markAsRemoved(), goog.array.removeAt(e, b), 0 == e.length && (delete this.listeners[a], this.typeCount_--), !0)
		: !1;
};
...
goog.events.unlistenByKey = function (a) {
	...
	(c = goog.events.getListenerMap_(b))
		? (c.removeByKey(a), 0 == c.getTypeCount() && ((c.src = null), (b[goog.events.LISTENER_MAP_PROP_] = null)))
		: a.markAsRemoved();
	return !0;
};
...
goog.events.removeAll = function (a, b) {
	...
	for (f in c.listeners)
		if (!e || f == e) for (var g = c.listeners[f].concat(), h = 0; h < g.length; ++h) goog.events.unlistenByKey(g[h]) && ++d;
	return d;
};
...
goog.html.SafeScript.unwrap = function (a) {
	if (
		...
		a.SAFE_SCRIPT_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeScript.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
...
goog.html.SafeStyle.unwrap = function (a) {
	if (
		...
		a.SAFE_STYLE_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeStyle.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
	...
	for (c in a) {
		...
		null != d &&
			(d instanceof goog.string.Const
				? ((d = goog.string.Const.unwrap(d)), goog.asserts.assert(!/[{;}]/.test(d), 'Value does not allow [{;}].'))
				: goog.html.SafeStyle.VALUE_RE_.test(d)
				? goog.html.SafeStyle.hasBalancedQuotes_(d) ||
				  (goog.asserts.fail('String value requires balanced quotes, got: ' + d), (d = goog.html.SafeStyle.INNOCUOUS_STRING))
				: (goog.asserts.fail('String value allows only [-,."\'%_!# a-zA-Z0-9], rgb() and rgba(), got: ' + d),
...
goog.html.SafeStyleSheet.unwrap = function (a) {
	if (
		...
		a.SAFE_STYLE_SHEET_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeStyleSheet.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
...
goog.i18n.bidi.estimateDirection = function (a, b) {
	for (
		var c = 0, d = 0, e = !1, f = goog.i18n.bidi.stripHtmlIfNeeded_(a, b).split(goog.i18n.bidi.wordSeparatorRe_), g = 0;
		g < f.length;
		g++
	) {
		var h = f[g];
...
goog.html.SafeUrl.unwrap = function (a) {
	if (
		...
		a.SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
...
goog.html.TrustedResourceUrl.unwrap = function (a) {
	if (
		...
		a.TRUSTED_RESOURCE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.TrustedResourceUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
...
goog.html.TrustedResourceUrl.format = function (a, b) {
	...
	var d = c.replace(goog.html.TrustedResourceUrl.FORMAT_MARKER_, function (a, d) {
		if (!Object.prototype.hasOwnProperty.call(b, d))
			throw Error(
				'Found marker, "' + d + '", in format string, "' + c + '", but no valid label mapping found in args: ' + JSON.stringify(b)
			);
		var e = b[d];
...
goog.html.TrustedResourceUrl.BASE_URL_ = new RegExp(
	'^' + goog.html.TrustedResourceUrl.SCHEME_AND_ORIGIN_ + goog.html.TrustedResourceUrl.BASE_ABSOLUTE_PATH_,
	'i'
);
...
goog.html.SafeHtml.unwrap = function (a) {
	if (
		...
		a.SAFE_HTML_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeHtml.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
	)
		return a.privateDoNotAccessOrElseSafeHtmlWrappedValue_;
...
goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function (a, b, c) {
	...
	goog.dom.tags.isVoidTag(a.toLowerCase())
		...
		: ((d = goog.html.SafeHtml.concat(c)), (e += '>' + goog.html.SafeHtml.unwrap(d) + '</' + a + '>'), (d = d.getDirection()));
...
goog.dom.safe.assertIsHTMLAnchorElement_ = function (a) {
	goog.asserts.ENABLE_ASSERTS &&
		...
		'undefined' != typeof Element &&
		goog.asserts.assert(
			a && (a instanceof HTMLAnchorElement || !(a instanceof Location || a instanceof Element)),
...
goog.dom.safe.assertIsHTMLLinkElement_ = function (a) {
	goog.asserts.ENABLE_ASSERTS &&
		...
		'undefined' != typeof Element &&
		goog.asserts.assert(
			a && (a instanceof HTMLLinkElement || !(a instanceof Location || a instanceof Element)),
...
goog.dom.getDocumentScroll_ = function (a) {
	...
	return goog.userAgent.IE && goog.userAgent.isVersionOrHigher('10') && a.pageYOffset != b.scrollTop
		? new goog.math.Coordinate(b.scrollLeft, b.scrollTop)
		: new goog.math.Coordinate(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop);
};
...
goog.dom.constHtmlToNode = function (a) {
	var b = goog.array.map(arguments, goog.string.Const.unwrap),
		b = goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(
			goog.string.Const.from('Constant HTML string, that gets turned into a Node later, so it will be automatically balanced.'),
			b.join('')
		);
...
goog.dom.safeHtmlToNode_ = function (a, b) {
	...
	goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT
		? (goog.dom.safe.setInnerHtml(c, goog.html.SafeHtml.concat(goog.html.SafeHtml.BR, b)), c.removeChild(c.firstChild))
...
goog.dom.getChildren = function (a) {
	return goog.dom.BrowserFeature.CAN_USE_CHILDREN_ATTRIBUTE && void 0 != a.children
		? a.children
...
goog.dom.isFocusable = function (a) {
	...
	return (b = goog.dom.nativelySupportsFocus_(a)
		? !a.disabled && (!goog.dom.hasSpecifiedTabIndex_(a) || goog.dom.isTabIndexFocusable_(a))
...
goog.dom.hasSpecifiedTabIndex_ = function (a) {
	return goog.userAgent.IE && !goog.userAgent.isVersionOrHigher('9')
		? ((a = a.getAttributeNode('tabindex')), goog.isDefAndNotNull(a) && a.specified)
...
goog.dom.hasNonZeroBoundingRect_ = function (a) {
	a =
		!goog.isFunction(a.getBoundingClientRect) || (goog.userAgent.IE && null == a.parentElement)
...
goog.dom.getTextContent_ = function (a, b, c) {
	if (!(a.nodeName in goog.dom.TAGS_TO_IGNORE_))
		...
		else for (a = a.firstChild; a; ) goog.dom.getTextContent_(a, b, c), (a = a.nextSibling);
};
...
goog.dom.matchesPixelRatio_ = function (a) {
	return goog.dom
		.getWindow()
		.matchMedia('(min-resolution: ' + a + 'dppx),(min--moz-device-pixel-ratio: ' + a + '),(min-resolution: ' + 96 * a + 'dpi)').matches
		? a
		: 0;
};
...
goog.math.Box.prototype.translate = function (a, b) {
	a instanceof goog.math.Coordinate
		...
		: (goog.asserts.assertNumber(a), (this.left += a), (this.right += a), goog.isNumber(b) && ((this.top += b), (this.bottom += b)));
	return this;
};
...
goog.math.Rect.prototype.translate = function (a, b) {
	a instanceof goog.math.Coordinate
		...
		: ((this.left += goog.asserts.assertNumber(a)), goog.isNumber(b) && (this.top += b));
	return this;
};
...
goog.style.getVendorStyleName_ = function (a, b) {
	...
	return void 0 === a.style[c] && ((c = goog.dom.vendor.getVendorJsPrefix() + goog.string.toTitleCase(c)), void 0 !== a.style[c])
...
goog.style.getComputedStyle = function (a, b) {
	var c = goog.dom.getOwnerDocument(a);
	return c.defaultView && c.defaultView.getComputedStyle && (c = c.defaultView.getComputedStyle(a, null))
...
goog.style.getComputedBoxSizing = function (a) {
	return (
		goog.style.getStyle_(a, 'boxSizing') || goog.style.getStyle_(a, 'MozBoxSizing') || goog.style.getStyle_(a, 'WebkitBoxSizing') || null
	);
};
...
goog.style.getClientViewportElement = function (a) {
	...
	return !goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9) || goog.dom.getDomHelper(a).isCss1CompatMode()
		? a.documentElement
		: a.body;
};
...
goog.style.getOffsetParent = function (a) {
	...
	for (a = a.parentNode; a && a != b; a = a.parentNode)
		if (
			(a.nodeType == goog.dom.NodeType.DOCUMENT_FRAGMENT && a.host && (a = a.host),
			(c = goog.style.getStyle_(a, 'position')),
...
goog.style.getVisibleRectForElement = function (a) {
	for (
		...
		if (
			!((goog.userAgent.IE && 0 == a.clientWidth) || (goog.userAgent.WEBKIT && 0 == a.clientHeight && a == d)) &&
			a != d &&
			a != e &&
...
goog.style.getContainerOffsetToScrollInto = function (a, b, c) {
	...
	d == goog.dom.getDocumentScrollElement()
		? ((b = e.x - d.scrollLeft),
		  (e = e.y - d.scrollTop),
		  goog.userAgent.IE && !goog.userAgent.isDocumentModeOrHigher(10) && ((b += g.left), (e += g.top)))
...
goog.style.getSizeWithDisplay_ = function (a) {
	...
	return (goog.isDef(b) && !d) || !a.getBoundingClientRect
		...
		: ((a = goog.style.getBoundingClientRect_(a)), new goog.math.Size(a.right - a.left, a.bottom - a.top));
};
...
goog.style.getOpacity = function (a) {
	...
	'opacity' in b
		...
		: 'MozOpacity' in b
		? (a = b.MozOpacity)
		: 'filter' in b && (b = b.filter.match(/alpha\(opacity=([\d.]+)\)/)) && (a = String(b[1] / 100));
	return '' == a ? a : Number(a);
};
goog.style.setOpacity = function (a, b) {
	...
	'opacity' in c
		...
		: 'MozOpacity' in c
		? (c.MozOpacity = b)
		: 'filter' in c && (c.filter = '' === b ? '' : 'alpha(opacity=' + 100 * Number(b) + ')');
};
goog.style.setTransparentBackgroundImage = function (a, b) {
	var c = a.style;
	goog.userAgent.IE && !goog.userAgent.isVersionOrHigher('8')
		? (c.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + b + '", sizingMethod="crop")')
		: ((c.backgroundImage = 'url(' + b + ')'), (c.backgroundPosition = 'top left'), (c.backgroundRepeat = 'no-repeat'));
};
...
goog.style.setUnselectable = function (a, b, c) {
	...
	if (d) {
		...
		if (((b = b ? 'on' : ''), a.setAttribute('unselectable', b), c)) for (a = 0; (e = c[a]); a++) e.setAttribute('unselectable', b);
};
...
goog.async.WorkQueue.prototype.remove = function () {
	var a = null;
	this.workHead_ &&
		((a = this.workHead_), (this.workHead_ = this.workHead_.next), this.workHead_ || (this.workTail_ = null), (a.next = null));
	return a;
};
...
goog.async.nextTick = function (a, b, c) {
	...
	goog.isFunction(goog.global.setImmediate) && (c || goog.async.nextTick.useSetImmediate_())
		...
		: (goog.async.nextTick.setImmediate_ || (goog.async.nextTick.setImmediate_ = goog.async.nextTick.getSetImmediateEmulator_()),
...
goog.Promise = function (a, b) {
	...
	0 < goog.Promise.UNHANDLED_REJECTION_DELAY
		...
		: 0 == goog.Promise.UNHANDLED_REJECTION_DELAY && (this.hadUnhandledRejection_ = !1);
	...
	if (this.callbackEntries_) {
		...
		d &&
			(this.state_ == goog.Promise.State_.PENDING && 1 == c
				? this.cancelInternal_(b)
				: (e ? this.removeEntryAfter_(e) : this.popEntry_(), this.executeCallback_(d, goog.Promise.State_.REJECTED, b)));
	}
};
...
goog.Promise.prototype.resolve_ = function (a, b) {
	this.state_ == goog.Promise.State_.PENDING &&
		(this === b && ((a = goog.Promise.State_.REJECTED), (b = new TypeError('Promise cannot resolve to itself'))),
		(this.state_ = goog.Promise.State_.BLOCKED),
		goog.Promise.maybeThen_(b, this.unblockAndFulfill_, this.unblockAndReject_, this) ||
			((this.result_ = b),
			(this.state_ = a),
			(this.parent_ = null),
			this.scheduleCallbacks_(),
...
goog.events.EventTarget.dispatchEventInternal_ = function (a, b, c) {
	...
	b.propagationStopped_ ||
		((f = b.currentTarget = a), (e = f.fireListeners(d, !0, b) && e), b.propagationStopped_ || (e = f.fireListeners(d, !1, b) && e));
	...
	if (this.enabled) {
		...
		0 < a && a < this.interval_ * goog.Timer.intervalScale
			...
			: (this.timer_ && (this.timerObject_.clearTimeout(this.timer_), (this.timer_ = null)),
			  this.dispatchTick(),
			  this.enabled && ((this.timer_ = this.timerObject_.setTimeout(this.boundTick_, this.interval_)), (this.last_ = goog.now())));
	}
};
...
goog.ui.Component.prototype.setId = function (a) {
	this.parent_ &&
		...
		(goog.object.remove(this.parent_.childIndex_, this.id_), goog.object.add(this.parent_.childIndex_, a, this));
	this.id_ = a;
};
...
goog.ui.Component.prototype.addChildAt = function (a, b, c) {
	...
	a.getParent() == this
		? (goog.object.set(this.childIndex_, a.getId(), a), goog.array.remove(this.children_, a))
	...
	a.inDocument_ && this.inDocument_ && a.getParent() == this
		? ((c = this.getContentElement()), (b = c.childNodes[b] || null), b != a.getElement() && c.insertBefore(a.getElement(), b))
		: c
		? (this.element_ || this.createDom(), (b = this.getChildAt(b + 1)), a.render_(this.getContentElement(), b ? b.element_ : null))
		: this.inDocument_ &&
		  !a.inDocument_ &&
		  a.element_ &&
...
goog.a11y.aria.setRole = function (a, b) {
	b
		? (goog.asserts.ENABLE_ASSERTS && goog.asserts.assert(goog.object.containsValue(goog.a11y.aria.Role, b), 'No such ARIA role ' + b),
...
goog.a11y.aria.setState = function (a, b, c) {
	...
	'' === c || void 0 == c
		? ((c = goog.a11y.aria.datatables.getDefaultValuesMap()), b in c ? a.setAttribute(d, c[b]) : a.removeAttribute(d))
		: a.setAttribute(d, c);
};
goog.a11y.aria.toggleState = function (a, b) {
	var c = goog.a11y.aria.getState(a, b);
	goog.string.isEmptyOrWhitespace(goog.string.makeSafe(c)) || 'true' == c || 'false' == c
...
goog.events.KeyHandler.USES_KEYDOWN_ =
	goog.userAgent.IE || goog.userAgent.EDGE || (goog.userAgent.WEBKIT && goog.userAgent.isVersionOrHigher('525'));
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function (a) {
	(goog.userAgent.WEBKIT || goog.userAgent.EDGE) &&
		((this.lastKey_ == goog.events.KeyCodes.CTRL && !a.ctrlKey) ||
			...
			(goog.userAgent.MAC && this.lastKey_ == goog.events.KeyCodes.META && !a.metaKey)) &&
		this.resetState();
	-1 == this.lastKey_ &&
		(a.ctrlKey && a.keyCode != goog.events.KeyCodes.CTRL
			...
			: a.metaKey && a.keyCode != goog.events.KeyCodes.META && (this.lastKey_ = goog.events.KeyCodes.META));
	goog.events.KeyHandler.USES_KEYDOWN_ &&
	!goog.events.KeyCodes.firesKeyPressEvent(a.keyCode, this.lastKey_, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
		? this.handleEvent(a)
...
goog.events.KeyHandler.prototype.handleEvent = function (a) {
	...
	goog.userAgent.IE && a.type == goog.events.EventType.KEYPRESS
		...
		: (goog.userAgent.WEBKIT || goog.userAgent.EDGE) && a.type == goog.events.EventType.KEYPRESS
		? ((c = this.keyCode_), (d = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(c) ? b.charCode : 0))
...
goog.ui.ContainerRenderer.prototype.setStateFromClassName = function (a, b, c) {
	b == c + '-disabled'
		...
		: b == c + '-vertical' && a.setOrientation(goog.ui.Container.Orientation.VERTICAL);
};
...
goog.ui.ControlRenderer.prototype.enableClassName = function (a, b, c) {
	if ((a = a.getElement ? a.getElement() : a)) {
		...
		goog.userAgent.IE &&
			...
			((d = this.getAppliedCombinedClassNames_(goog.dom.classlist.get(a), b)), d.push(b));
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
	...
	c && c.firstChild
		? a.setContentInternal(c.firstChild.nextSibling ? goog.array.clone(c.childNodes) : c.firstChild)
...
goog.ui.ControlRenderer.prototype.updateAriaState = function (a, b, c) {
	...
	goog.asserts.assert(a, 'The element passed as a first parameter cannot be null.');
	(b = goog.ui.ControlRenderer.getAriaStateForAriaRole_(a, goog.ui.ControlRenderer.ariaAttributeMap_[b])) &&
...
goog.ui.Control.prototype.supportedStates_ =
	goog.ui.Component.State.DISABLED | goog.ui.Component.State.HOVER | goog.ui.Component.State.ACTIVE | goog.ui.Component.State.FOCUSED;
...
goog.ui.Control.prototype.addClassName = function (a) {
	a &&
		(this.extraClassNames_ ? goog.array.contains(this.extraClassNames_, a) || this.extraClassNames_.push(a) : (this.extraClassNames_ = [a]),
...
goog.ui.Control.prototype.removeClassName = function (a) {
	a &&
		...
		(0 == this.extraClassNames_.length && (this.extraClassNames_ = null), this.renderer_.enableExtraClassName(this, a, !1));
};
...
goog.ui.Control.prototype.enterDocument = function () {
	...
	if (
		...
		(this.isHandleMouseEvents() && this.enableMouseEventHandling_(!0), this.isSupportedState(goog.ui.Component.State.FOCUSED))
	) {
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function (a) {
	...
	a
		? (b
		  ...
		  goog.userAgent.IE &&
				(goog.userAgent.isVersionOrHigher(9) || b.listen(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
		...
		: (b
		  ...
		  goog.userAgent.IE &&
				(goog.userAgent.isVersionOrHigher(9) || b.unlisten(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
...
goog.ui.Control.prototype.isTransitionAllowed = function (a, b) {
	return (
		this.isSupportedState(a) &&
		this.hasState(a) != b &&
		(!(this.statesWithTransitionEvents_ & a) || this.dispatchEvent(goog.ui.Component.getStateTransitionEvent(a, b))) &&
		!this.isDisposed()
	);
};
...
goog.ui.Container.prototype.enterDocument = function () {
	...
	this.getHandler()
		...
		.listen(goog.dom.getOwnerDocument(a), goog.events.EventType.MOUSEUP, this.handleDocumentMouseUp)
		.listen(
			a,
			[
...
goog.ui.Container.prototype.handleHighlightItem = function (a) {
	...
	if (-1 < b && b != this.highlightedIndex_) {
		...
		this.openFollowsHighlight_ &&
			this.openItem_ &&
			c != this.openItem_ &&
			(c.isSupportedState(goog.ui.Component.State.OPENED) ? c.setOpen(!0) : this.openItem_.setOpen(!1));
	}
	b = this.getElement();
...
goog.ui.Container.prototype.handleKeyEvent = function (a) {
	return this.isEnabled() && this.isVisible() && (0 != this.getChildCount() || this.keyEventTarget_) && this.handleKeyEventInternal(a)
...
goog.ui.Container.prototype.handleKeyEventInternal = function (a) {
	...
	if (
		...
		(this.openItem_ && this.openItem_ != b && 'function' == typeof this.openItem_.handleKeyEvent && this.openItem_.handleKeyEvent(a))
	)
		return !0;
...
goog.ui.Container.prototype.setEnabled = function (a) {
	this.enabled_ != a &&
		this.dispatchEvent(a ? goog.ui.Component.EventType.ENABLE : goog.ui.Component.EventType.DISABLE) &&
		(a
			? ((this.enabled_ = !0),
			  this.forEachChild(function (a) {
...
goog.ui.MenuItemRenderer.prototype.createDom = function (a) {
	...
	this.setEnableCheckBoxStructure(
		a,
		b,
		a.isSupportedState(goog.ui.Component.State.SELECTED) || a.isSupportedState(goog.ui.Component.State.CHECKED)
	);
	return b;
};
...
goog.ui.MenuItemRenderer.prototype.setEnableCheckBoxStructure = function (a, b, c) {
	...
	c != this.hasCheckBoxStructure(b) &&
		...
		c
			? ((c = this.getCompositeCssClass_(goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX)),
			  b.insertBefore(a.getDomHelper().createDom('DIV', c), b.firstChild || null))
...
goog.ui.MenuItem.prototype.getCaption = function () {
	...
	if (goog.isArray(a)) {
		var b = goog.ui.MenuItem.ACCELERATOR_CLASS,
			...
			a = goog.array
				.map(a, function (a) {
					return goog.dom.isElement(a) && (goog.dom.classlist.contains(a, b) || goog.dom.classlist.contains(a, c))
						? ''
...
goog.ui.PaletteRenderer.prototype.createCell = function (a, b) {
	var c = b.createDom(
		'TD',
		{ class: this.getCssClass() + '-cell', id: this.getCssClass() + '-cell-' + goog.ui.PaletteRenderer.cellId_++ },
		a
	);
...
goog.ui.PaletteRenderer.prototype.highlightCell = function (a, b, c) {
	b &&
		...
		c
			? goog.a11y.aria.setState(a.getElementStrict(), goog.a11y.aria.State.ACTIVEDESCENDANT, b.id)
			: b.id == goog.a11y.aria.getState(a.getElementStrict(), goog.a11y.aria.State.ACTIVEDESCENDANT) &&
			  goog.a11y.aria.removeState(a.getElementStrict(), goog.a11y.aria.State.ACTIVEDESCENDANT));
};
...
goog.ui.SelectionModel.prototype.selectItem_ = function (a, b) {
	a &&
		('function' == typeof this.selectionHandler_ ? this.selectionHandler_(a, b) : 'function' == typeof a.setSelected && a.setSelected(b));
};
...
goog.ui.Palette.prototype.handleMouseDown = function (a) {
	...
	this.isActive() &&
		((a = this.getRenderer().getContainingItem(this, a.target)), a != this.getHighlightedItem() && this.setHighlightedItem(a));
};
...
goog.ui.Palette.prototype.setHighlighted = function (a) {
	a && -1 == this.highlightedIndex_
		? this.setHighlightedIndex(-1 < this.lastHighlightedIndex_ ? this.lastHighlightedIndex_ : 0)
...
goog.ui.ColorPalette.prototype.createColorNodes = function () {
	return goog.array.map(
		...
		function (a, b) {
			...
			c.title =
				this.labels_ && this.labels_[b] ? this.labels_[b] : '#' == a.charAt(0) ? 'RGB (' + goog.color.hexToRgb(a).join(', ') + ')' : a;
			return c;
		},
		this
	);
...
goog.events.FocusHandler.prototype.handleEvent = function (a) {
	...
	b.type =
		'focusin' == a.type || 'focus' == a.type ? goog.events.FocusHandler.EventType.FOCUSIN : goog.events.FocusHandler.EventType.FOCUSOUT;
	this.dispatchEvent(b);
};
...
goog.structs.Map.prototype.remove = function (a) {
	return goog.structs.Map.hasKey_(this.map_, a)
		? (delete this.map_[a], this.count_--, this.version_++, this.keys_.length > 2 * this.count_ && this.cleanupKeysArray_(), !0)
		: !1;
};
...
goog.debug.exposeExceptionAsHtml = function (a, b) {
	try {
		...
		return goog.html.SafeHtml.concat(
			goog.html.SafeHtml.htmlEscapePreservingNewlinesAndSpaces('Message: ' + c.message + '\nUrl: '),
...
goog.debug.Logger.logToProfilers = function (a) {
	goog.global.console &&
		(goog.global.console.timeStamp
			...
			: goog.global.console.markTimeline && goog.global.console.markTimeline(a));
...
goog.debug.Logger.prototype.doLogRecord_ = function (a) {
	...
	if (goog.debug.Logger.ENABLE_HIERARCHY) for (var b = this; b; ) b.callPublish_(a), (b = b.getParent());
...
goog.ui.tree.BaseNode.prototype.getExpandIconSafeHtml = function () {
	return goog.html.SafeHtml.create('span', { type: 'expand', style: { display: 'inline-block' }, class: this.getExpandIconClass() });
};
...
goog.ui.tree.TypeAhead.prototype.handleNavigation = function (a) {
	...
	switch (a.keyCode) {
		...
		case goog.events.KeyCodes.UP:
			a.ctrlKey &&
				(this.jumpTo_(a.keyCode == goog.events.KeyCodes.DOWN ? goog.ui.tree.TypeAhead.Offset.DOWN : goog.ui.tree.TypeAhead.Offset.UP),
				(b = !0));
			break;
...
goog.ui.tree.TypeAhead.prototype.handleTypeAheadChar = function (a) {
	...
	a.ctrlKey ||
		...
		goog.string.isUnicodeChar(a) && (' ' != a || this.buffer_) && ((this.buffer_ += a), (b = this.jumpToLabel_(this.buffer_))));
	return b;
};
...
goog.ui.tree.TypeAhead.prototype.jumpToLabel_ = function (a) {
	...
	(a = this.nodeMap_.getKeys(a)) &&
		a.length &&
		((this.matchingLabelIndex_ = this.matchingNodeIndex_ = 0), (b = this.nodeMap_.get(a[0])), (b = this.selectMatchingNode_(b))) &&
...
goog.events.BrowserFeature.TOUCH_ENABLED &&
	(Blockly.Touch.TOUCH_MAP = { mousedown: ['touchstart'], mousemove: ['touchmove'], mouseup: ['touchend', 'touchcancel'] });
Blockly.longPid_ = 0;
...
Blockly.onMouseUp_ = function (a) {
	...
	a.dragMode_ != Blockly.DRAG_NONE &&
		...
		(a.dragMode_ = Blockly.DRAG_NONE),
		Blockly.Touch.onTouchUpWrapper_ && (Blockly.unbindEvent_(Blockly.Touch.onTouchUpWrapper_), (Blockly.Touch.onTouchUpWrapper_ = null)),
...
Blockly.onMouseMove_ = function (a) {
	...
	if (b.dragMode_ != Blockly.DRAG_NONE) {
		...
		Math.sqrt(c * c + d * d) > Blockly.DRAG_RADIUS && (Blockly.longStop_(), (b.dragMode_ = Blockly.DRAG_FREE));
		a.stopPropagation();
		a.preventDefault();
	}
};
...
Blockly.Touch.checkTouchIdentifier = function (a) {
	var b =
		a.changedTouches && a.changedTouches[0] && void 0 != a.changedTouches[0].identifier && null != a.changedTouches[0].identifier
			? a.changedTouches[0].identifier
			: 'mouse';
	return void 0 != Blockly.Touch.touchIdentifier_ && null != Blockly.Touch.touchIdentifier_
...
Blockly.Workspace.prototype.renameVariable = function (a, b) {
	...
	c == d || (-1 != c && -1 == d)
		...
		: (this.variableList.push(b), console.log('Tried to rename an non-existent variable.'));
};
	...
	if (-1 != c) {
		for (var d = this.getVariableUses(a), e = 0, f; (f = d[e]); e++)
			if ('procedures_defnoreturn' == f.type || 'procedures_defreturn' == f.type) {
				...
				Blockly.alert(Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace('%1', a).replace('%2', e));
				return;
			}
		var g = this;
		1 < d.length
			? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace('%1', d.length).replace('%2', a), function (a) {
					a && b();
			  })
			: b();
	}
...
Blockly.Workspace.prototype.fireChangeListener = function (a) {
	a.recordUndo &&
		(this.undoStack_.push(a), (this.redoStack_.length = 0), this.undoStack_.length > this.MAX_UNDO && this.undoStack_.unshift());
...
Blockly.Bubble = function (a, b, c, d, e, f) {
	...
	(e && f) ||
		((b = this.content_.getBBox()), (e = b.width + 2 * Blockly.Bubble.BORDER_WIDTH), (f = b.height + 2 * Blockly.Bubble.BORDER_WIDTH));
...
Blockly.Bubble.unbindDragEvents_ = function () {
	...
	Blockly.Bubble.onMouseMoveWrapper_ &&
		(Blockly.unbindEvent_(Blockly.Bubble.onMouseMoveWrapper_), (Blockly.Bubble.onMouseMoveWrapper_ = null));
};
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
	...
	this.bubbleBack_ = Blockly.utils.createSvgElement(
		'rect',
		{ class: 'blocklyDraggable', x: 0, y: 0, rx: Blockly.Bubble.BORDER_WIDTH, ry: Blockly.Bubble.BORDER_WIDTH },
		c
	);
	b
		? ((this.resizeGroup_ = Blockly.utils.createSvgElement(
		  ...
		  Blockly.utils.createSvgElement('polygon', { points: '0,x x,x x,0'.replace(/x/g, c.toString()) }, this.resizeGroup_),
		  Blockly.utils.createSvgElement('line', { class: 'blocklyResizeLine', x1: c / 3, y1: c - 1, x2: c - 1, y2: c / 3 }, this.resizeGroup_),
		  Blockly.utils.createSvgElement(
				'line',
				{ class: 'blocklyResizeLine', x1: (2 * c) / 3, y1: c - 1, x2: c - 1, y2: (2 * c) / 3 },
				this.resizeGroup_
		  ))
	...
	Blockly.utils.isRightButton(a)
		...
		: Blockly.utils.isTargetInput(a) ||
		  ...
		  this.workspace_.startDrag(
				a,
				new goog.math.Coordinate(this.workspace_.RTL ? -this.relativeLeft_ : this.relativeLeft_, this.relativeTop_)
		  ),
...
Blockly.Bubble.prototype.layoutBubble_ = function () {
	...
	this.workspace_.RTL
		? d - c.viewLeft - a - this.width_ < Blockly.Scrollbar.scrollbarThickness
			? (a = d - c.viewLeft - this.width_ - Blockly.Scrollbar.scrollbarThickness)
			: d - c.viewLeft - a > c.viewWidth && (a = d - c.viewLeft - c.viewWidth)
		: d + a < c.viewLeft
		? (a = c.viewLeft - d)
		: c.viewLeft + c.viewWidth < d + a + this.width_ + Blockly.BlockSvg.SEP_SPACE_X + Blockly.Scrollbar.scrollbarThickness &&
		  (a = c.viewLeft + c.viewWidth - d - this.width_ - Blockly.Scrollbar.scrollbarThickness);
...
Blockly.Bubble.prototype.setBubbleSize = function (a, b) {
	...
	this.resizeGroup_ &&
		(this.workspace_.RTL
			? this.resizeGroup_.setAttribute('transform', 'translate(' + 2 * Blockly.Bubble.BORDER_WIDTH + ',' + (b - c) + ') scale(-1 1)')
			: this.resizeGroup_.setAttribute('transform', 'translate(' + (a - c) + ',' + (b - c) + ')'));
...
Blockly.Icon.prototype.createIcon = function () {
	this.iconGroup_ ||
		...
		this.block_.isInFlyout && Blockly.utils.addClass(this.iconGroup_, 'blocklyIconGroupReadonly'),
...
Blockly.Comment.prototype.createEditor_ = function () {
	...
	Blockly.bindEventWithChecks_(b, 'change', this, function (a) {
		this.text_ != b.value &&
			(Blockly.Events.fire(new Blockly.Events.Change(this.block_, 'comment', null, this.text_, b.value)), (this.text_ = b.value));
	});
	setTimeout(function () {
		b.focus();
	}, 0);
...
Blockly.Comment.prototype.setVisible = function (a) {
	if (a != this.isVisible())
		if (
			(Blockly.Events.fire(new Blockly.Events.Ui(this.block_, 'commentOpen', !a, a)),
			...
			a
				? ((this.bubble_ = new Blockly.Bubble(
				  ...
				  this.updateColour())
				: (this.bubble_.dispose(), (this.foreignObject_ = this.textarea_ = this.bubble_ = null));
			this.setText(b);
...
Blockly.Connection.prototype.isConnectionAllowed = function (a) {
	...
	return (a.type == Blockly.INPUT_VALUE && a.isConnected() && !a.targetBlock().isMovable() && !a.targetBlock().isShadow()) ||
	...
	a
		? (goog.isArray(a) || (a = [a]),
		  ...
		  this.isConnected() &&
				...
				((this.isSuperior() ? this.targetBlock() : this.sourceBlock_).unplug(), this.sourceBlock_.bumpNeighbours_()))
		: (this.check_ = null);
	return this;
};
...
Blockly.Field.prototype.init = function () {
	this.fieldGroup_ ||
		...
		(this.textElement_ = Blockly.utils.createSvgElement('text', { class: 'blocklyText', y: this.size_.height - 12.5 }, this.fieldGroup_)),
		this.updateEditable(),
...
Blockly.Field.getCachedWidth = function (a) {
	var b = a.textContent + '\n' + a.className.baseVal;
	if (Blockly.Field.cacheWidths_ && Blockly.Field.cacheWidths_[b]) var c = Blockly.Field.cacheWidths_[b];
	else {
		try {
	...
	if (null !== a) {
		...
		b != a &&
			(this.sourceBlock_ &&
				...
				Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, b, a)),
			this.setText(a));
	}
};
Blockly.Field.prototype.onMouseUp_ = function (a) {
	if ((!goog.userAgent.IPHONE && !goog.userAgent.IPAD) || goog.userAgent.isVersionOrHigher('537.51.2') || 0 === a.layerX || 0 === a.layerY)
		Blockly.utils.isRightButton(a) || this.sourceBlock_.workspace.isDragging() || (this.sourceBlock_.isEditable() && this.showEditor_());
};
...
Blockly.Tooltip.createDom = function () {
	Blockly.Tooltip.DIV ||
		((Blockly.Tooltip.DIV = goog.dom.createDom('DIV', 'blocklyTooltipDiv')), document.body.appendChild(Blockly.Tooltip.DIV));
};
...
Blockly.Tooltip.show_ = function () {
	...
	if (Blockly.Tooltip.DIV) {
		...
		a
			...
			: c + Blockly.Tooltip.DIV.offsetWidth > b.width + window.scrollX - 2 * Blockly.Tooltip.MARGINS &&
...
Blockly.FieldLabel.prototype.init = function () {
	this.textElement_ ||
		((this.textElement_ = Blockly.utils.createSvgElement('text', { class: 'blocklyText', y: this.size_.height - 5 }, null)),
...
Blockly.Input.prototype.setVisible = function (a) {
	...
	this.connection &&
		(a ? (b = this.connection.unhideAll()) : this.connection.hideAll(), (d = this.connection.targetBlock())) &&
...
Blockly.Options.parseToolboxTree = function (a) {
	a
		? ('string' != typeof a &&
				('undefined' == typeof XSLTProcessor && a.outerHTML ? (a = a.outerHTML) : a instanceof Element || (a = null)),
...
Blockly.ScrollbarPair = function (a) {
	...
	this.corner_ = Blockly.utils.createSvgElement(
		'rect',
		{ height: Blockly.Scrollbar.scrollbarThickness, width: Blockly.Scrollbar.scrollbarThickness, class: 'blocklyScrollbarBackground' },
		null
	);
...
Blockly.Scrollbar = function (a, b, c) {
	...
	b
		? (this.svgBackground_.setAttribute('height', Blockly.Scrollbar.scrollbarThickness),
		  this.outerSvg_.setAttribute('height', Blockly.Scrollbar.scrollbarThickness),
		...
		: (this.svgBackground_.setAttribute('width', Blockly.Scrollbar.scrollbarThickness),
		  this.outerSvg_.setAttribute('width', Blockly.Scrollbar.scrollbarThickness),
...
Blockly.Scrollbar.prototype.setPosition = function (a, b) {
	this.position_.x = a;
	this.position_.y = b;
	this.outerSvg_.style.transform = 'translate(' + (this.position_.x + this.origin_.x) + 'px,' + (this.position_.y + this.origin_.y) + 'px)';
};
Blockly.Scrollbar.prototype.resize = function (a) {
	...
	Blockly.Scrollbar.metricsAreEquivalent_(a, this.oldHostMetrics_) ||
		((this.oldHostMetrics_ = a), this.horizontal_ ? this.resizeHorizontal_(a) : this.resizeVertical_(a), this.onScroll_());
};
...
Blockly.Scrollbar.prototype.resizeViewHorizontal = function (a) {
	...
	this.setPosition(b, a.absoluteTop + a.viewHeight - Blockly.Scrollbar.scrollbarThickness - 0.5);
...
Blockly.Scrollbar.prototype.createDom_ = function () {
	...
	this.svgHandle_ = Blockly.utils.createSvgElement('rect', { class: 'blocklyScrollbarHandle', rx: a, ry: a }, this.svgGroup_);
...
Blockly.Scrollbar.prototype.cleanUp_ = function () {
	...
	Blockly.Scrollbar.onMouseUpWrapper_ &&
		(Blockly.unbindEvent_(Blockly.Scrollbar.onMouseUpWrapper_), (Blockly.Scrollbar.onMouseUpWrapper_ = null));
	Blockly.Scrollbar.onMouseMoveWrapper_ &&
		(Blockly.unbindEvent_(Blockly.Scrollbar.onMouseMoveWrapper_), (Blockly.Scrollbar.onMouseMoveWrapper_ = null));
};
...
Blockly.Trashcan.prototype.createDom = function () {
	...
	Blockly.utils
		...
		.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', this.workspace_.options.pathToMedia + Blockly.SPRITE.url);
		...
		(this.workspace_.RTL
			? ((this.left_ = this.MARGIN_SIDE_ + Blockly.Scrollbar.scrollbarThickness),
			  a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT &&
					((this.left_ += a.flyoutWidth), this.workspace_.toolbox_ && (this.left_ += a.absoluteLeft)))
			: ((this.left_ = a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_ - Blockly.Scrollbar.scrollbarThickness),
...
Blockly.Trashcan.prototype.animateLid_ = function () {
	...
	this.svgLid_.setAttribute(
		'transform',
		'rotate(' + (this.workspace_.RTL ? -a : a) + ',' + (this.workspace_.RTL ? 4 : this.WIDTH_ - 4) + ',' + (this.LID_HEIGHT_ - 2) + ')'
	);
...
Blockly.utils.getRelativeXY = function (a) {
	...
	(a = a.getAttribute('style')) &&
		...
		((c = a.match(Blockly.utils.getRelativeXY.XY_2D_REGEX_)) || (c = a.match(Blockly.utils.getRelativeXY.XY_3D_REGEX_)),
...
Blockly.utils.tokenizeInterpolation = function (a) {
			  ...
			  ('' == g
					...
					: ((d = a.join('')),
					  /[a-zA-Z][a-zA-Z0-9_]*/.test(d)
							? ((g = d.toUpperCase()),
							  (g = goog.string.startsWith(g, 'BKY_') ? g.substring(4) : null) && g in Blockly.Msg
									? ((d = Blockly.utils.tokenizeInterpolation(Blockly.Msg[g])), (b = b.concat(d)))
									: b.push('%{' + d + '}'))
							: b.push('%{' + d + '}'),
					  (d = a.length = 0)));
	}
	...
	for (f = a.length = 0; f < b.length; ++f)
		'string' == typeof b[f] ? a.push(b[f]) : ((g = a.join('')) && c.push(g), (a.length = 0), c.push(b[f]));
	(g = a.join('')) && c.push(g);
	a.length = 0;
	return c;
};
...
Blockly.utils.wrapLine_ = function (a, b) {
	...
	do {
		e = d;
		f = a;
		for (var h = [], k = c.length / g, n = 1, d = 0; d < c.length - 1; d++) n < (d + 1.5) / k ? (n++, (h[d] = !0)) : (h[d] = !1);
...
Blockly.workspaceDragSurfaceSvg.prototype.translateSurface = function (a, b) {
	a = a.toFixed(0);
	b = b.toFixed(0);
	this.SVG_.setAttribute('style', 'transform: translate3d(' + a + 'px, ' + b + 'px, 0px); display: block;');
};
	...
	for (d = 0; (e = a.inputList[d]); d++) {
		...
		e.type != Blockly.DUMMY_INPUT &&
			...
			e.type == Blockly.INPUT_VALUE
				...
				: e.type == Blockly.NEXT_STATEMENT && (k = goog.dom.createDom('statement')),
	...
	for (var e = a.getAttribute('id'), c = b.newBlock(d, e), f = null, e = 0, g; (g = a.childNodes[e]); e++)
		if (3 != g.nodeType) {
			for (var h = (f = null), k = 0, n; (n = g.childNodes[k]); k++)
				1 == n.nodeType && ('block' == n.nodeName.toLowerCase() ? (f = n) : 'shadow' == n.nodeName.toLowerCase() && (h = n));
			!f && h && (f = h);
			...
			switch (g.nodeName.toLowerCase()) {
				...
				case 'next':
					...
					f &&
						(goog.asserts.assert(c.nextConnection, 'Next statement does not exist.'),
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
	...
	a &&
		((this.svgBackground_ = Blockly.utils.createSvgElement('rect', { height: '100%', width: '100%', class: a }, this.svgGroup_)),
...
Blockly.WorkspaceSvg.prototype.highlightBlock = function (a, b) {
	...
	if ((d = a ? this.getBlockById(a) : null))
		(c = void 0 === b || b)
			? -1 == this.highlightedBlocks_.indexOf(d) && this.highlightedBlocks_.push(d)
...
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function (a) {
	...
	Blockly.utils.isTargetInput(a)
		...
		: (Blockly.terminateDrag_(),
		  ...
		  a.target &&
				a.target.nodeName &&
				('svg' == a.target.nodeName.toLowerCase() || a.target == this.svgBackground_) &&
				Blockly.selected &&
				!this.options.readOnly &&
				Blockly.selected.unselect(),
		  Blockly.utils.isRightButton(a)
				? (this.showContextMenu_(a), Blockly.onMouseUp_(a), Blockly.Touch.clearTouchIdentifier())
				: this.scrollbar
				? ((this.dragMode_ = Blockly.DRAG_BEGIN),
				  ...
				  'mouseup' in Blockly.Touch.TOUCH_MAP &&
						...
						(Blockly.Touch.onTouchUpWrapper_ = Blockly.Touch.onTouchUpWrapper_.concat(
							Blockly.bindEventWithChecks_(document, 'mouseup', null, Blockly.onMouseUp_)
						))),
				  (Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_ || []),
				  (Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_.concat(
						Blockly.bindEventWithChecks_(document, 'mousemove', null, Blockly.onMouseMove_)
				  )))
				: Blockly.Touch.clearTouchIdentifier(),
		  a.stopPropagation(),
		  a.preventDefault());
...
Blockly.WorkspaceSvg.prototype.isDragging = function () {
	return (
		...
		(Blockly.Flyout.startFlyout_ && Blockly.Flyout.startFlyout_.dragMode_ == Blockly.DRAG_FREE) ||
...
Blockly.WorkspaceSvg.prototype.getBlocksBoundingBox = function () {
	...
	return { x: b.topLeft.x, y: b.topLeft.y, width: b.bottomRight.x - b.topLeft.x, height: b.bottomRight.y - b.topLeft.y };
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
	...
	if (!this.options.readOnly && !this.isFlyout) {
		...
		d.push(g);
		this.scrollbar &&
			((g = {}), (g.text = Blockly.Msg.CLEAN_UP), (g.enabled = 1 < e.length), (g.callback = this.cleanUp.bind(this)), d.push(g));
		if (this.options.collapse) {
			for (var h = (g = !1), k = 0; k < e.length; k++)
				for (var n = e[k]; n; ) n.isCollapsed() ? (g = !0) : (h = !0), (n = n.getNextBlock());
			var p = function (a) {
		...
		g = {
			...
			callback: function () {
				2 > l.length
					? c()
					: Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace('%1', l.length), function (a) {
							a && c();
					  });
			}
		};
...
Blockly.WorkspaceSvg.prototype.playAudio = function (a, b) {
	...
	if (c) {
		...
		d - this.lastSound_ < Blockly.SOUND_LIMIT ||
			((this.lastSound_ = d),
			(c =
				(goog.userAgent.DOCUMENT_MODE && 9 === goog.userAgent.DOCUMENT_MODE) || goog.userAgent.IPAD || goog.userAgent.ANDROID
					? c
					: c.cloneNode()),
...
Blockly.WorkspaceSvg.prototype.zoom = function (a, b, c) {
	...
	c > this.options.zoomOptions.maxScale
		...
		: c < this.options.zoomOptions.minScale && (d = this.options.zoomOptions.minScale / this.scale);
	this.scale != c &&
		(this.scrollbar &&
			((a = f
				.getCTM()
...
Blockly.Mutator.prototype.updateEditable = function () {
	this.block_.isInFlyout ||
		(this.block_.isEditable()
			? this.iconGroup_ && Blockly.utils.removeClass(this.iconGroup_, 'blocklyIconGroupReadonly')
			: (this.setVisible(!1), this.iconGroup_ && Blockly.utils.addClass(this.iconGroup_, 'blocklyIconGroupReadonly')));
	Blockly.Icon.prototype.updateEditable.call(this);
};
...
Blockly.Block = function (a, b, c) {
	...
	goog.isFunction(this.onchange) &&
		((this.onchangeWrapper_ = this.onchange.bind(this)), this.workspace.addChangeListener(this.onchangeWrapper_));
};
			...
			for (var b = this.getConnections_(!1), c = 0, d; (d = b[c]); c++) {
				...
				for (var e = d.neighbours_(Blockly.SNAP_RADIUS), f = 0, g; (g = e[f]); f++)
					(d.isConnected() && g.isConnected()) ||
						(g.getSourceBlock().getRootBlock() != a && (d.isSuperior() ? g.bumpAwayFrom_(d) : d.bumpAwayFrom_(g)));
			}
	}
};
...
Blockly.Block.prototype.setInputsInline = function (a) {
	this.inputsInline != a &&
		(Blockly.Events.fire(new Blockly.Events.Change(this, 'inline', null, this.inputsInline, a)), (this.inputsInline = a));
};
...
Blockly.Block.prototype.setCollapsed = function (a) {
	this.collapsed_ != a &&
		(Blockly.Events.fire(new Blockly.Events.Change(this, 'collapsed', null, this.collapsed_, a)), (this.collapsed_ = a));
};
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
	...
	for (var g = 0; g < d.length; g++) {
		var h = d[g];
		'number' == typeof h
			? (goog.asserts.assert(0 < h && h <= b.length, 'Message index "%s" out of range.', h),
	...
	a.length &&
		('string' == typeof a[a.length - 1] || goog.string.startsWith(a[a.length - 1].type, 'field_')) &&
...
Blockly.BlockSvg.terminateDrag = function () {
	...
	Blockly.BlockSvg.onMouseUpWrapper_ &&
		(Blockly.unbindEvent_(Blockly.BlockSvg.onMouseUpWrapper_), (Blockly.BlockSvg.onMouseUpWrapper_ = null));
	Blockly.BlockSvg.onMouseMoveWrapper_ &&
		(Blockly.unbindEvent_(Blockly.BlockSvg.onMouseMoveWrapper_), (Blockly.BlockSvg.onMouseMoveWrapper_ = null));
	...
	if (d) {
		do {
			...
			this.useDragSurface_ &&
				...
				((e = this.workspace.blockDragSurface_.getSurfaceTranslation()), (a += e.x), (b += e.y));
			d = d.parentNode;
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function () {
	var a = this.getRelativeToSurfaceXY(this),
		...
		d;
	this.RTL
		? ((d = new goog.math.Coordinate(a.x - (c.width - b), a.y)), (a = new goog.math.Coordinate(a.x + b, a.y + c.height)))
...
Blockly.BlockSvg.prototype.onMouseDown_ = function (a) {
	if (!this.workspace.options.readOnly)
		if (this.isInFlyout)
			'touchstart' == a.type &&
				Blockly.utils.isRightButton(a) &&
				(Blockly.Flyout.blockRightClick_(a, this), a.stopPropagation(), a.preventDefault());
		else {
...
Blockly.BlockSvg.prototype.onMouseUp_ = function (a) {
	...
	Blockly.selected && Blockly.highlightedConnection_
		? (Blockly.localConnection_.connect(Blockly.highlightedConnection_),
		  this.rendered &&
				(Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_)
					.getSourceBlock()
					.connectionUiEffect(),
		...
		: !this.getParent() &&
		  ...
		  ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), Blockly.selected.dispose(!1, !0));
	...
	if ('mousemove' == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation();
		...
		if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
			...
			this.useDragSurface_
				...
				: ((d.translate_ = 'translate(' + c.x + ',' + c.y + ')'), d.setAttribute('transform', d.translate_ + d.skew_));
			for (c = 0; c < this.draggedBubbles_.length; c++)
				(d = this.draggedBubbles_[c]), d.bubble.setIconLocation(goog.math.Coordinate.sum(d, b));
			...
			Blockly.highlightedConnection_ &&
				...
				(Blockly.highlightedConnection_.unhighlight(), (Blockly.highlightedConnection_ = null), (Blockly.localConnection_ = null));
...
Blockly.BlockSvg.prototype.connectionUiEffect = function () {
	...
	if (!(1 > this.workspace.scale)) {
		var a = this.workspace.getSvgXY(this.svgGroup_);
		this.outputConnection
			? ((a.x += (this.RTL ? 3 : -3) * this.workspace.scale), (a.y += 13 * this.workspace.scale))
			: this.previousConnection && ((a.x += (this.RTL ? -23 : 23) * this.workspace.scale), (a.y += 3 * this.workspace.scale));
		a = Blockly.utils.createSvgElement(
			'circle',
			{ cx: a.x, cy: a.y, r: 0, fill: 'none', stroke: '#888', 'stroke-width': 10 },
...
Blockly.BlockSvg.disconnectUiStep_ = function (a, b, c) {
	...
	1 < d
		? (a.skew_ = '')
		: ((a.skew_ = 'skewX(' + Math.round(Math.sin(d * Math.PI * 3) * (1 - d) * b) + ')'),
...
Blockly.BlockSvg.prototype.updateDisabled = function () {
	this.disabled || this.getInheritedDisabled()
		...
		: Blockly.utils.removeClass(this.svgGroup_, 'blocklyDisabled') && this.updateColour();
...
Blockly.BlockSvg.prototype.setCommentText = function (a) {
	var b = !1;
	goog.isString(a)
		? (this.comment || ((this.comment = new Blockly.Comment(this)), (b = !0)), this.comment.setText(a))
...
Blockly.BlockSvg.prototype.setWarningText = function (a, b) {
	...
	else for (var d in this.setWarningText.pid_) clearTimeout(this.setWarningText.pid_[d]), delete this.setWarningText.pid_[d];
	if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
		var e = this;
		...
		d = !1;
		goog.isString(a)
			? (this.warning || ((this.warning = new Blockly.Warning(this)), (d = !0)), this.warning.setText(a, c))
			: this.warning && !c
			? (this.warning.dispose(), (d = !0))
			: this.warning &&
			  ((d = this.warning.getText()), this.warning.setText('', c), (f = this.warning.getText()) || this.warning.dispose(), (d = d == f));
	...
	this.rendered &&
		(a
			? (this.svgPath_.setAttribute('filter', 'url(#' + this.workspace.options.embossFilterId + ')'),
			  (this.svgPathLight_.style.display = 'none'))
			: (this.svgPath_.removeAttribute('filter'), delete this.svgPathLight_.style.display));
};
...
Blockly.BlockSvg.TOP_LEFT_CORNER_START_HIGHLIGHT_RTL =
	'm ' + Blockly.BlockSvg.DISTANCE_45_INSIDE + ',' + Blockly.BlockSvg.DISTANCE_45_INSIDE;
Blockly.BlockSvg.TOP_LEFT_CORNER_START_HIGHLIGHT_LTR = 'm 0.5,' + (Blockly.BlockSvg.CORNER_RADIUS - 0.5);
Blockly.BlockSvg.TOP_LEFT_CORNER =
	'A ' + Blockly.BlockSvg.CORNER_RADIUS + ',' + Blockly.BlockSvg.CORNER_RADIUS + ' 0 0,1 ' + Blockly.BlockSvg.CORNER_RADIUS + ',0';
	...
	for (var d = 0, e; (e = a[d]); d++) {
		...
		f &&
			(this.RTL
				...
				: (f.setAttribute('transform', 'translate(' + (b + e.renderSep) + ',' + c + ')'),
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
	...
	for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; (l = b[p]); p++)
		if (l.isVisible()) {
			...
			n || p != b.length - 1
				? !n && l.type == Blockly.INPUT_VALUE && b[p + 1] && b[p + 1].type == Blockly.NEXT_STATEMENT && l.renderHeight--
				: l.renderHeight--;
			...
			m.type != Blockly.BlockSvg.INLINE &&
				(m.type == Blockly.NEXT_STATEMENT
					...
					: (m.type == Blockly.INPUT_VALUE ? (f = !0) : m.type == Blockly.DUMMY_INPUT && (h = !0), (d = Math.max(d, l.fieldWidth))));
		}
	for (a = 0; (m = c[a]); a++)
	...
	f
		? (c.rightEdge = Math.max(c.rightEdge, d + 2 * Blockly.BlockSvg.SEP_SPACE_X + Blockly.BlockSvg.TAB_WIDTH))
	...
	this.squareTopLeftCorner_
		? (a.push('m 0,0'),
		  ...
		  this.startHat_ &&
				...
				b.push(this.RTL ? Blockly.BlockSvg.START_HAT_HIGHLIGHT_RTL : Blockly.BlockSvg.START_HAT_HIGHLIGHT_LTR)))
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f) {
	for (var g, h = 0, k, n, p = 0, l; (l = e[p]); p++) {
		...
		if (this.isCollapsed()) {
			...
			a.push('v', m);
			this.RTL && (b.push('v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5'), b.push('v', m - 0.7));
			...
			for (var q = 0; (m = l[q]); q++)
				(k = h),
					...
					m.type == Blockly.INPUT_VALUE &&
						(c.push('M', g - Blockly.BlockSvg.SEP_SPACE_X + ',' + (h + Blockly.BlockSvg.INLINE_PADDING_Y)),
						...
						this.RTL
							...
							: (d.push('M', g - Blockly.BlockSvg.SEP_SPACE_X + 0.5 + ',' + (h + Blockly.BlockSvg.INLINE_PADDING_Y + 0.5)),
							  ...
							  d.push(
									...
									g -
										...
										0.9 +
										',' +
										(h + Blockly.BlockSvg.INLINE_PADDING_Y + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
							  ),
							  d.push('l', 0.46 * Blockly.BlockSvg.TAB_WIDTH + ',-2.1')),
						(k = this.RTL
							? -g - Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X + m.renderWidth + 1
							: g + Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X - m.renderWidth - 1),
			...
			l.type == Blockly.INPUT_VALUE
				? ((m = l[0]),
				  ...
				  m.align != Blockly.ALIGN_LEFT &&
						((q = e.rightEdge - m.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X),
				  ...
				  a.push('v', q),
				  this.RTL
						? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push('v', q + 0.5))
						: (b.push('M', e.rightEdge - 5 + ',' + (h + Blockly.BlockSvg.TAB_HEIGHT - 0.7)),
				  ...
				  m.connection.isConnected() &&
						(this.width = Math.max(
							this.width,
							e.rightEdge + m.connection.targetBlock().getHeightWidth().width - Blockly.BlockSvg.TAB_WIDTH + 1
						)))
				: l.type == Blockly.DUMMY_INPUT
				? ((m = l[0]),
				  (k = h),
				  m.align != Blockly.ALIGN_LEFT &&
						((q = e.rightEdge - m.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
				...
				: l.type == Blockly.NEXT_STATEMENT &&
				  ...
				  (k = h),
				  m.align != Blockly.ALIGN_LEFT &&
						((q = e.statementEdge - m.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
						m.align == Blockly.ALIGN_RIGHT ? (g += q) : m.align == Blockly.ALIGN_CENTRE && (g += q / 2)),
				  this.renderFields_(m.fieldRow, g, k),
				  ...
				  this.RTL
						? (b.push(
								'M',
								g - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + ',' + (h + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
						  ),
				  ...
				  m.connection.isConnected() &&
						(this.width = Math.max(this.width, e.statementEdge + m.connection.targetBlock().getHeightWidth().width)),
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c) {
	this.height += c + 1;
	this.nextConnection &&
		(a.push('H', Blockly.BlockSvg.NOTCH_WIDTH + (this.RTL ? 0.5 : -0.5) + ' ' + Blockly.BlockSvg.NOTCH_PATH_RIGHT),
	...
	this.squareBottomLeftCorner_
		...
		: (a.push('H', Blockly.BlockSvg.CORNER_RADIUS),
		  ...
		  this.RTL ||
				(b.push('M', Blockly.BlockSvg.DISTANCE_45_INSIDE + ',' + (c - Blockly.BlockSvg.DISTANCE_45_INSIDE)),
				b.push(
					'A',
					Blockly.BlockSvg.CORNER_RADIUS -
						0.5 +
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (a, b) {
	this.outputConnection
		? (this.outputConnection.setOffsetInBlock(0, 0),
		  ...
		  this.RTL
				? (b.push('M', -0.25 * Blockly.BlockSvg.TAB_WIDTH + ',8.4'), b.push('l', -0.45 * Blockly.BlockSvg.TAB_WIDTH + ',-2.1'))
				: (b.push('V', Blockly.BlockSvg.TAB_HEIGHT - 1.5),
				  b.push('m', -0.92 * Blockly.BlockSvg.TAB_WIDTH + ',-0.5 q ' + -0.19 * Blockly.BlockSvg.TAB_WIDTH + ',-5.5 0,-11'),
				  b.push('m', 0.92 * Blockly.BlockSvg.TAB_WIDTH + ',1 V 0.5 H 1')),
		  (this.width += Blockly.BlockSvg.TAB_WIDTH))
		: this.RTL || (this.squareTopLeftCorner_ ? b.push('V', 0.5) : b.push('V', Blockly.BlockSvg.CORNER_RADIUS));
	a.push('z');
};
Blockly.Events = {};
...
Blockly.Events.fire = function (a) {
	Blockly.Events.isEnabled() &&
		(Blockly.Events.FIRE_QUEUE_.length || setTimeout(Blockly.Events.fireNow_, 0), Blockly.Events.FIRE_QUEUE_.push(a));
};
		...
		for (var f = d + 1, g; (g = c[f]); f++)
			e.type == g.type &&
				...
				(e.type == Blockly.Events.MOVE
					? ((e.newParentId = g.newParentId), (e.newInputName = g.newInputName), (e.newCoordinate = g.newCoordinate), c.splice(f, 1), f--)
					: e.type == Blockly.Events.CHANGE && e.element == g.element && e.name == g.name
					? ((e.newValue = g.newValue), c.splice(f, 1), f--)
					: e.type != Blockly.Events.UI ||
					  'click' != g.element ||
					  ('commentOpen' != e.element && 'mutatorOpen' != e.element && 'warningOpen' != e.element) ||
					  ((e.newValue = g.newValue), c.splice(f, 1), f--));
...
Blockly.Events.Move.prototype.fromJson = function (a) {
	...
	a.newCoordinate &&
		((a = a.newCoordinate.split(',')), (this.newCoordinate = new goog.math.Coordinate(parseFloat(a[0]), parseFloat(a[1]))));
};
...
Blockly.FieldTextInput.prototype.setText = function (a) {
	null !== a &&
		...
		a !== this.text_ &&
			(this.sourceBlock_ &&
				Blockly.Events.isEnabled() &&
				Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, this.text_, a)),
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function (a) {
	...
	13 == a.keyCode
		...
		: 9 == a.keyCode && (Blockly.WidgetDiv.hide(), this.sourceBlock_.tab(this, !a.shiftKey), a.preventDefault());
};
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
	...
	if (a.firstChild) {
		var a = Blockly.utils.createSvgElement(
			...
			b = Blockly.utils.createSvgElement(
				'circle',
				{ cx: Blockly.FieldAngle.HALF, cy: Blockly.FieldAngle.HALF, r: Blockly.FieldAngle.RADIUS, class: 'blocklyAngleCircle' },
				a
			);
		this.gauge_ = Blockly.utils.createSvgElement('path', { class: 'blocklyAngleGauge' }, a);
		this.line_ = Blockly.utils.createSvgElement(
			'line',
			{ x1: Blockly.FieldAngle.HALF, y1: Blockly.FieldAngle.HALF, class: 'blocklyAngleLine' },
			a
		);
...
Blockly.FieldCheckbox.prototype.setValue = function (a) {
	...
	this.state_ !== a &&
		(this.sourceBlock_ &&
			Blockly.Events.isEnabled() &&
			Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, this.state_, a)),
		(this.state_ = a),
...
Blockly.FieldColour.prototype.setValue = function (a) {
	this.sourceBlock_ &&
		Blockly.Events.isEnabled() &&
		this.colour_ != a &&
		Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, this.colour_, a));
	this.colour_ = a;
...
Blockly.FieldDropdown.prototype.init = function () {
	if (!this.fieldGroup_) {
		...
		this.arrow_.appendChild(
			document.createTextNode(this.sourceBlock_.RTL ? Blockly.FieldDropdown.ARROW_CHAR + ' ' : ' ' + Blockly.FieldDropdown.ARROW_CHAR)
		);
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
	...
	this.sourceBlock_.RTL
		? ((f.x += e.width), (f.x += Blockly.FieldDropdown.CHECKMARK_OVERHANG), f.x < d.x + h.width && (f.x = d.x + h.width))
		: ((f.x -= Blockly.FieldDropdown.CHECKMARK_OVERHANG), f.x > c.width + d.x - h.width && (f.x = c.width + d.x - h.width));
...
Blockly.FieldDropdown.prototype.setValue = function (a) {
	if (null !== a && a !== this.value_) {
		this.sourceBlock_ &&
			Blockly.Events.isEnabled() &&
			Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, 'field', this.name, this.value_, a));
		this.value_ = a;
	...
	if (this.visible_) {
		...
		if (this.imageJson_) {
			this.imageElement_ = Blockly.utils.createSvgElement(
				'image',
				{ y: 5, height: this.imageJson_.height + 'px', width: this.imageJson_.width + 'px' },
				this.fieldGroup_
			);
			...
			this.sourceBlock_.RTL
				? (this.imageElement_.setAttribute('x', a), this.textElement_.setAttribute('x', -1))
				: (this.textElement_.setAttribute('text-anchor', 'end'), this.textElement_.setAttribute('x', this.size_.width + 1));
		} else
...
Blockly.FieldImage.prototype.setValue = function (a) {
	null !== a &&
		((this.src_ = a), this.imageElement_ && this.imageElement_.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', a || ''));
};
...
Blockly.Variables.flyoutCategory = function (a) {
	...
	if (0 < b.length) {
		Blockly.Blocks.variables_set &&
			...
			Blockly.Blocks.math_change ? a.setAttribute('gap', 8) : a.setAttribute('gap', 24),
		...
		Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, d, function (d) {
			d
				? -1 != a.variableIndexOf(d)
					? Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace('%1', d.toLowerCase()), function () {
							c(d);
					  })
...
Blockly.Variables.promptName = function (a, b, c) {
	Blockly.prompt(a, b, function (a) {
		a &&
			((a = a.replace(/[\s\xa0]+/g, ' ').replace(/^ | $/g, '')), a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) &&
			(a = null);
		c(a);
	});
};
		...
		this.getValue() ||
			this.setValue(
				Blockly.Variables.generateUniqueName(
					this.sourceBlock_.isInFlyout ? this.sourceBlock_.workspace.targetWorkspace : this.sourceBlock_.workspace
				)
			),
...
Blockly.Procedures.flyoutCategory = function (a) {
	...
	Blockly.Blocks.procedures_defreturn &&
		...
		d.setAttribute('gap', 16),
		(e = goog.dom.createDom('field', null, Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE)),
		e.setAttribute('name', 'NAME'),
		d.appendChild(e),
		c.push(d));
...
Blockly.FlyoutButton.prototype.createDom = function () {
	...
	if (!this.isLabel_)
		var b = Blockly.utils.createSvgElement('rect', { class: 'blocklyFlyoutButtonShadow', rx: 4, ry: 4, x: 1, y: 1 }, this.svgGroup_);
	var a = Blockly.utils.createSvgElement(
			'rect',
			{ class: this.isLabel_ ? 'blocklyFlyoutLabelBackground' : 'blocklyFlyoutButtonBackground', rx: 4, ry: 4 },
			this.svgGroup_
		),
		c = Blockly.utils.createSvgElement(
			'text',
			{ class: this.isLabel_ ? 'blocklyFlyoutLabelText' : 'blocklyText', x: 0, y: 0, 'text-anchor': 'middle' },
			this.svgGroup_
		);
...
Blockly.Flyout.prototype.init = function (a) {
	...
	this.autoClose ||
		((this.filterWrapper_ = this.filterForCapacity_.bind(this)), this.targetWorkspace_.addChangeListener(this.filterWrapper_));
...
Blockly.Flyout.prototype.getMetrics_ = function () {
	...
	} else (c = 0), (d = this.height_ - 2 * this.SCROLLBAR_PADDING), (e = this.width_), this.RTL || (e -= this.SCROLLBAR_PADDING);
	return {
		viewHeight: d,
		viewWidth: e,
...
Blockly.Flyout.prototype.setMetrics_ = function (a) {
	...
	b &&
		(!this.horizontalLayout_ && goog.isNumber(a.y)
			...
			: this.horizontalLayout_ && goog.isNumber(a.x) && (this.workspace_.scrollX = -b.contentWidth * a.x),
	...
	if (this.isVisible()) {
		...
		if (a) {
			this.setBackgroundPath_(
				this.horizontalLayout_ ? a.viewWidth - 2 * this.CORNER_RADIUS : this.width_ - this.CORNER_RADIUS,
				this.horizontalLayout_ ? this.height_ - this.CORNER_RADIUS : a.viewHeight - 2 * this.CORNER_RADIUS
			);
	...
	for (var b = [], c = [], d = (this.permanentlyDisabled_.length = 0), e; (e = a[d]); d++)
		if (e.tagName) {
			...
			if ('BLOCK' == f)
				...
				(e = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_, e, 'LABEL' == f)),
					b.push({ type: 'button', button: e }),
					c.push(g);
		}
	this.layout_(b, c);
	this.listeners_.push(
		Blockly.bindEventWithChecks_(this.svgBackground_, 'mouseover', this, function () {
...
Blockly.Flyout.prototype.onMouseUp_ = function (a) {
	this.workspace_.isDragging() ||
		...
		this.autoClose
			...
			: Blockly.WidgetDiv.isVisible() || Blockly.Events.fire(new Blockly.Events.Ui(Blockly.Flyout.startBlock_, 'click', void 0, void 0)));
	Blockly.terminateDrag_();
};
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function (a) {
	('mousemove' == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) ||
		(this.determineDragIntention_(a.clientX - Blockly.Flyout.startDownEvent_.clientX, a.clientY - Blockly.Flyout.startDownEvent_.clientY)
			? (Blockly.longStop_(), this.createBlockFunc_(Blockly.Flyout.startBlock_)(Blockly.Flyout.startDownEvent_))
			: this.dragMode_ == Blockly.DRAG_FREE && (Blockly.longStop_(), this.onMouseMove_(a)));
	a.stopPropagation();
};
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
	...
	var c = b.isMutator ? this.workspace_.getSvgXY(c) : Blockly.utils.getInjectionDivXY_(c),
...
Blockly.Flyout.terminateDrag_ = function () {
	Blockly.Flyout.startFlyout_ &&
		(Blockly.Flyout.startFlyout_.dragMode_ == Blockly.DRAG_FREE && Blockly.Touch.clearTouchIdentifier(),
	...
	Blockly.Flyout.onMouseMoveBlockWrapper_ &&
		(Blockly.unbindEvent_(Blockly.Flyout.onMouseMoveBlockWrapper_), (Blockly.Flyout.onMouseMoveBlockWrapper_ = null));
	Blockly.Flyout.onMouseMoveWrapper_ &&
		(Blockly.unbindEvent_(Blockly.Flyout.onMouseMoveWrapper_), (Blockly.Flyout.onMouseMoveWrapper_ = null));
	Blockly.Flyout.startDownEvent_ = null;
	Blockly.Flyout.startBlock_ = null;
};
...
Blockly.Toolbox = function (a) {
	...
	this.horizontalLayout_ &&
		((this.config_.cssTreeRow += a.RTL ? ' blocklyHorizontalTreeRtl' : ' blocklyHorizontalTree'),
		(this.treeSeparatorConfig_.cssTreeRow =
			'blocklyTreeSeparatorHorizontal ' + (a.RTL ? 'blocklyHorizontalTreeRtl' : 'blocklyHorizontalTree')),
	...
	if (a) {
		...
		this.horizontalLayout_
			? ((a.style.left = '0'),
			  ...
			  this.toolboxPosition == Blockly.TOOLBOX_AT_TOP ? (a.style.top = '0') : (a.style.bottom = '0'))
			: (this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ? (a.style.right = '0') : (a.style.left = '0'),
		...
		if (g.tagName)
			switch (g.tagName.toUpperCase()) {
				case 'CATEGORY':
					...
					goog.isString(h)
						? (h.match(/^#[0-9a-fA-F]{6}$/) ? (e.hexColour = h) : (e.hexColour = Blockly.hueToRgb(h)), (this.hasColours_ = !0))
						: (e.hexColour = '');
				...
				case 'SEP':
					e &&
						('CATEGORY' == e.tagName.toUpperCase()
							...
							: ((g = parseFloat(g.getAttribute('gap'))), !isNaN(g) && e && e.setAttribute('gap', g)));
					break;
				case 'BLOCK':
				case 'SHADOW':
				case 'LABEL':
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function (a) {
	...
	if (a != this.selectedItem_ && a != b.tree_) {
		...
		c != a &&
			c != this &&
			((c = new Blockly.Events.Ui(null, 'category', c && c.getHtml(), a && a.getHtml())),
...
Blockly.WidgetDiv.createDom = function () {
	Blockly.WidgetDiv.DIV ||
		((Blockly.WidgetDiv.DIV = goog.dom.createDom('DIV', 'blocklyWidgetDiv')), document.body.appendChild(Blockly.WidgetDiv.DIV));
};
...
Blockly.createDom_ = function (a, b) {
	...
	var c = Blockly.utils.createSvgElement(
		...
		f = Blockly.utils.createSvgElement('filter', { id: 'blocklyEmbossFilter' + e }, d);
	...
	f = Blockly.utils.createSvgElement(
		'pattern',
		{ id: 'blocklyDisabledPattern' + e, patternUnits: 'userSpaceOnUse', width: 10, height: 10 },
		d
	);
	...
	d = Blockly.utils.createSvgElement('pattern', { id: 'blocklyGridPattern' + e, patternUnits: 'userSpaceOnUse' }, d);
	0 < b.gridOptions.length &&
		0 < b.gridOptions.spacing &&
		(Blockly.utils.createSvgElement('line', { stroke: b.gridOptions.colour }, d),
		1 < b.gridOptions.length && Blockly.utils.createSvgElement('line', { stroke: b.gridOptions.colour }, d));
	b.gridPattern = d;
	return c;
};
		...
		e.addChangeListener(function () {
			if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
				...
				if (
					...
					a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c)
				)
			...
			Blockly.selected &&
				...
				86 == a.keyCode
					? Blockly.clipboardXml_ &&
					  (Blockly.Events.setGroup(!0), Blockly.clipboardSource_.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1))
					: 90 == a.keyCode && (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey));
		b &&
			(Blockly.Events.setGroup(!0),
			Blockly.hideChaff(),
...
Blockly.defineBlocksWithJsonArray = function (a) {
	for (var b = 0, c; (c = a[b]); b++) Blockly.Blocks[c.type] = { init: Blockly.jsonInitFactory_(c) };
};
