      ...
      <div id='mySidenav' className='sidenav'>
        ...
        {isLoggedIn && (
          <a className='nav-link'>
            <FontAwesomeIcon icon={Icons.faUser} /> &nbsp; {loginEmail.substring(0, loginEmail.indexOf('@'))}
          </a>
        )}
        <Link
        ...
        >
          <FontAwesomeIcon icon='cogs' /> Setup/Movement
        </Link>
        <Link
          id='coding-link'
          to='/coding'
        ...
        >
          <FontAwesomeIcon icon='code' /> Coding
        </Link>
        <Link
          id='vision-link'
          to='/vision-page'
        ...
        >
          <FontAwesomeIcon icon={Icons.faCamera} /> Vision
        </Link>
        {isLoggedIn && (
          <Link
            id='analytics-link'
          ...
          >
            <FontAwesomeIcon icon={Icons.faChartBar} /> Analytics
          </Link>
        )}
        {isLoggedIn && (
          <Link
          ...
          >
            <FontAwesomeIcon icon={Icons.faChartBar} /> History
          </Link>
        )}
        {isLoggedIn && (
          <Link
          ...
          >
            <FontAwesomeIcon icon={Icons.faList} /> Context History
          </Link>
        )}
        {isLoggedIn ? (
          authorizationRestrictedRoutes.includes(pathname) ? (
            <Link
              className='nav-link'
              to='/start'
              onClick={() => {
        ...
        {!isLoggedIn && (
          <a className='nav-link' data-toggle='modal' data-target='#registerModal'>
            <FontAwesomeIcon icon={Icons.faUserPlus} /> Signup
          </a>
        )}
      </div>
