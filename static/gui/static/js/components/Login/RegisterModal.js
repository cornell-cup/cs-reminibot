...
class RegisterModal extends React.Component {
	...
	handleRegister(event) {
		...
		if (formData.get('email') == formData.get('email_confirmation') && formData.get('password') == formData.get('password_confirmation')) {
			...
			('The email/password does not match.');
		}
	}
					...
					<div className='modal-content'>
						...
						<form className='signup' id='registerForm' method='POST'>
							<div className='modal-body'>
								...
								<div className='form-group'>
									<label htmlFor='confirm_email' className='col-form-label'>
								...
								<div className='form-group'>
									<label htmlFor='confirm_password' className='col-form-label'>
										Confirm Password:
									</label>
									<input
										id='confirm_password'
							...
							<div className='modal-footer'>
								<button type='submit' value='submit' className='btn btn-primary' data-dismiss='modal' onClick={this.handleRegister}>
									Sign Up
								</button>
							</div>
						</form>
