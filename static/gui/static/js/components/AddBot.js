        ...
        render() {
                ...
                function Ports(props) {
                    ...
                    for (let i = 0; i < ports.length; i++) {
                        buttonList.push( < li > < button className = "btn_ports"
                            onClick = {
                                () => props.motorPorts(props.portName, ports[i])
                            } > {
                                ports[i]
                            } < /button></li > );
                    }
                    ...
                    class Speech_Recognition extends React.Component {
                        constructor(props) {
                            super(props);
                            this.state = {
                                on: false
                    ...
                    export default class AddBot extends React.Component {
                        ...
                        render() {
                            ...
                            return ( <
                                ...
                                /select> <
                                /div> <
                                Button id = "remove_bot"
                                name = "Remove"
                                onClick = {
                                    () => _this.deleteBotListener()
                                }
                                bot_list = {
                                    this.props.bot_list
                                }
                                ...
                                div className = "col text-center" >
                                <
                                button className = "btn_btn-dir_movement"
                                onClick = {
                                    () => this.buttonMapListener("forward")
                                } > forward < /button> <
                                br / >
                                <
                                button className = "btn_btn-dir_movement"
                                onClick = {
                                    () => this.buttonMapListener("left")
                                } > left < /button> <
                                button className = "btn_btn-dir_movement"
                                onClick = {
                                ...
                                button className = "btn_btn-dir_movement"
                                onClick = {
                                    () => this.buttonMapListener("right")
                                } > right < /button> <
                                br / >
                                <
                                button className = "btn_btn-dir_movement"
                                onClick = {
                                    () => this.buttonMapListener("backward")
                                } > backward < /button> <
                                br / >
                                <
                                br / >
                                ...
                                /> <
                                button className = "btn btn-success element-wrapper mr-1"
                                onClick = {
