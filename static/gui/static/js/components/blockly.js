...
class PythonEditor extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.getEditor().getValue() !== nextProps.blocklyPythonCode) {
            this.getEditor().setValue(nextProps.blocklyPythonCode);
        }
    }
    ...
    updateCode(code) {
        this.props.setBlocklyPythonCode(code);
    ...
    downloadPython(event) {
        ...
        element.setAttribute('href', 'data:text/plain;charset=utf-8,' + 
                encodeURIComponent(this.props.blocklyPythonCode));
    ...
    runScript(event) {
        ...
        axios({
            ...
            data: JSON.stringify({
                ...
                script_code: this.props.blocklyPythonCode
            }),
            ...
            <div id="Python" className="col">
                ...
                <div className="row">
                    ...
                    >
                        <CodeMirror
                            ref="editor"
                            value={this.props.blocklyPythonCode}
                ...
                <div className="row">
                    <div className="col horizontalDiv">
                        ...
                        <Button
                            id={"CBlock"}
                            onClick={() => this.props.customBlock(this.state.functionName, this.props.blocklyPythonCode)}
    ...
    */
    ...
    runBlockly(event) {
        ...
        axios({
            ...
            data: JSON.stringify({
                bot_name: _this.props.selectedBotName,
                script_code: _this.props.blocklyPythonCode
            }),
        }).catch(function (error) {
            if (error.response.data.error_msg.length > 0)
                window.alert(error.response.data.error_msg);
                ...
                <div className="container-coding">
                    ...
                    <div className="row">
                        ...
                        <PythonEditor
                            ...
                            blocklyPythonCode={this.props.blocklyPythonCode}
