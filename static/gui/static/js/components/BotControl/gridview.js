...
export default class GridView extends React.Component {
  ...
  drawGrid() {
    ...
    this.svg
      .attr('width', this.state.width + 30)
  ...
  drawBot(x, y, z, o) {
    ...
    var image = this.svg
      ...
      .attr(
        'xlink:href',
        'https://media.licdn.com/dms/image/C510BAQGykNIrqhEdwA/company-logo_200_200/0?e=2159024400&v=beta&t=a_p2RqS1wnk78rvFhlKl2ivlm4eaqeB2eu5lrIhGROo'
      )
    ...
    return (
      <div className='control-option'>
        ...
        <div className='mb-3 d-flex'>
          ...
          <button onClick={this.displayRobot} name={'Display Bot'} className='btn btn-secondary ml-auto'>
            Display Bot
          </button>
        </div>
