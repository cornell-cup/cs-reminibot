...
import { MIC_BTN, MIC_BTNON, ACT_MIC_COMMAND } from '../../utils/Constants.js'
...
function BotVoiceControl({ selectedBotName, activeMicComponent, setActiveMicComponent, botVoiceControlMic, setBotVoiceControlMic }) {
  ...
  return (
    <React.Fragment>
      <div id='speech-button' className='row'>
        ...
        ></input>
        <button className='btn btn-danger element-wrapper btn-speech' onClick={toggle}>
          <div className='row'>
