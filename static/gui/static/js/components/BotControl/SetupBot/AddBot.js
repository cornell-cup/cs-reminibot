...
import { INFOBOXTYPE, INFOBOXID, CARROT_COLLAPSED, CARROT_EXPAND, INFO_ICON } from '../../utils/Constants.js'
        ...
        <div className='container'>
          ...
          <div className='row'>
            <div className='col horizontalDivCenter'>
              ...
              <button className='btn btn-secondary' onClick={this.addBotListener}>
                Add Bot
              </button>
            </div>
          </div>
          <div className='row'>
            <div className='col horizontalDivCenter'>
              ...
              <button className='btn btn-secondary' style={_this.props.selectedBotStyle} onClick={() => _this.deleteBotListener()}>
                Remove
              </button>
            </div>
          </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col horizontalDivCenter'>
              ...
              <button className='btn btn-success element-wrapper mr-1' onClick={() => this.modeSelectionOnClick('object_detection')}>
                Object Detection
              </button>
              <button className='btn btn-primary element-wrapper mr-1' onClick={() => this.modeSelectionOnClick('color_detection')}>
                Color Detection
              </button>
            </div>
          </div>
