        ...
        <div className="form-row">
          <div className="form-group col-md-6">
            ...
            <div className="input-group">
              <input type="text" className="form-control" id="filename" placeholder="Virtual Enviroment Filename" value={filename} onChange={(e) => { setFilename(e.target.value.replace(/\s/g, '')) }} />
              <div class="input-group-append">
                <a download={filename} href={virtualEnviroment.getDownloadableFileHref()}>
                  <button className="btn btn-outline-success" type="button" id="download"  >Download</button>
                </a>
              </div>
            </div>
          </div>
