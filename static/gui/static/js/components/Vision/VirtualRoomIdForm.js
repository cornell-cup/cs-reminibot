        ...
        <div className="form-row">
          <div className="form-group col-md-6">
            ...
            <div className="input-group">
              <input type="text" className="form-control" id="id" placeholder="Virtual Room ID" value={virtualRoomId} onChange={(e) => { setVirtualRoomId(e.target.value.replace(/\s/g, '')) }} />
              <div class="input-group-append">
                <CopyToClipboard text={virtualRoomId} onCopy={() => alert("The virtual room ID has been copied to your clipboard")}>
                  <button className="btn btn-outline-secondary" type="button" id="copy">Copy to clipboard</button>
                </CopyToClipboard>
              </div>
            </div>
          </div>
