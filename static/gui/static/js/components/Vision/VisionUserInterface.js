...
const VisionUserInterface = (props) => {
	...
	const forms = [
		<CircleForm virtualRoomId={virtualRoomId} />,
		<RectangleForm virtualRoomId={virtualRoomId} />,
		<RegularPolygonForm virtualRoomId={virtualRoomId} />,
		<PolygonForm virtualRoomId={virtualRoomId} />,
		<MinibotForm virtualRoomId={virtualRoomId} />,
		<RemoveObjectForm virtualRoomId={virtualRoomId} />,
		<VirtualRoomIdForm virtualRoomId={virtualRoomId}></VirtualRoomIdForm>,
		<ImportVirtualEnviromentForm virtualRoomId={virtualRoomId} />,
		<ExportVirtualEnviromentForm virtualRoomId={virtualRoomId} />
	];
	useEffect(() => {
