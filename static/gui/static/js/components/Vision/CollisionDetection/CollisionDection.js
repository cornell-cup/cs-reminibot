...
import { CIRCLE, get2DShapeClassification, POLYGON, RECTANGLE, OVAL } from './2DShapeClassification';
import { doCirclesOverlap } from './Circle';
import { doPolygonAndCircleOverlap, doPolygonAndRectangleOverlap, doPolygonsOverlap } from './Polygon';
import { doRectangleAndCircleOverlap, doRectanglesOverlap } from './Rectangle';

export const do2ShapesCollide = (shape1, shape2) => {
	switch (get2DShapeClassification(shape1) + get2DShapeClassification(shape2)) {
		...
		case POLYGON + POLYGON:
			return doPolygonsOverlap(getPolygonVertices(shape1), getPolygonVertices(shape2));
