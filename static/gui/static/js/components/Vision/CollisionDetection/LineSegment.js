...
export const getPolygonLineSegments = (vertices) => {
	return vertices.map((vertex, i) => [vertex, getItemCircular(vertices, i + 1)]);
};
...
export const doLinesIntersect = (lineSegment1, lineSegment2) => {
    ...
    */
	...
	const Ua =
		((lineSegment2[1][0] - lineSegment2[0][0]) * (lineSegment1[0][1] - lineSegment2[0][1]) -
			(lineSegment2[1][1] - lineSegment2[0][1]) * (lineSegment1[0][0] - lineSegment2[0][0])) /
		((lineSegment2[1][1] - lineSegment2[0][1]) * (lineSegment1[1][0] - lineSegment1[0][0]) -
			(lineSegment2[1][0] - lineSegment2[0][0]) * (lineSegment1[1][1] - lineSegment1[0][1]));
	const Ub =
		((lineSegment1[1][0] - lineSegment1[0][0]) * (lineSegment1[0][1] - lineSegment2[0][1]) -
			(lineSegment1[1][1] - lineSegment1[0][1]) * (lineSegment1[0][0] - lineSegment2[0][0])) /
		((lineSegment2[1][1] - lineSegment2[0][1]) * (lineSegment1[1][0] - lineSegment1[0][0]) -
			(lineSegment2[1][0] - lineSegment2[0][0]) * (lineSegment1[1][1] - lineSegment1[0][1]));
...
export const projectPointOntoLine = (point, lineSegment) => {
	...
	const Cx = point[0];
	const Cy = point[1];
	const t = ((Cx - Ax) * (Bx - Ax) + (Cy - Ay) * (By - Ay)) / ((Bx - Ax) * (Bx - Ax) + (By - Ay) * (By - Ay));
...
export const isPointInLine = (point, lineSegment) => {
	...
	return arePointsColinear(point1, point2, point3) && minX <= point[0] && point[0] <= maxX && minY <= point[1] && point[1] <= maxY;
};
