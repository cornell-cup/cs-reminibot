...
def pictures(args, color, image_counter, image_name, path, image_dim, window_dim):
    """
    Add documentation here as well as in the code.
    """
    i = 1
    while i + 1 < len(args):
        try:
...
if __name__=="__main__":
    ...
    image_dim = (300, 300) # lets keep this at 300 x 300.
    window_dim = (600, 600)
    pictures(args, color, image_counter, image_name, path, image_dim, window_dim)
